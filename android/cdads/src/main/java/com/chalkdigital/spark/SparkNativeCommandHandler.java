...
public class SparkNativeCommandHandler {
    interface SparkCommandFailureListener {
        void onFailure(SparkCommandException exception);
    }
    ...
    void createCalendarEvent(final Context context, final Map<String, String> params)
        ...
        if (isCalendarAvailable(context)) {
            try {
                ...
                throw new SparkCommandException(e);
            } catch (Exception e) {
                Utils.logStackTrace(e);
            ...
            throw new SparkCommandException("Action is " +
    ...
    void storePicture(@NonNull final Context context,
                      ...
                      @NonNull SparkNativeCommandHandler.SparkCommandFailureListener failureListener) throws SparkCommandException {
        if (!isStorePictureSupported(context)) {
            ...
            throw new SparkCommandException("Error downloading file " +
    ...
    void downloadImage(final Context context, final String uriString,
                       final SparkNativeCommandHandler.SparkCommandFailureListener failureListener) {
        final SparkNativeCommandHandler.DownloadImageAsyncTask downloadImageAsyncTask = new SparkNativeCommandHandler.DownloadImageAsyncTask(context,
                new SparkNativeCommandHandler.DownloadImageAsyncTask.DownloadImageAsyncTaskListener() {
                    @Override
                    ...
                    public void onFailure() {
                        ...
                        failureListener.onFailure(new SparkCommandException("Error " +
    ...
    static class DownloadImageAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        private final SparkNativeCommandHandler.DownloadImageAsyncTask.DownloadImageAsyncTaskListener mListener;

        public DownloadImageAsyncTask(@NonNull final Context context,
                                      @NonNull final SparkNativeCommandHandler.DownloadImageAsyncTask.DownloadImageAsyncTaskListener listener) {
            super();
        ...
        private void loadPictureIntoGalleryApp(final String filename) {
            SparkNativeCommandHandler.CDAdMediaScannerConnectionClient mediaScannerConnectionClient =
                    new SparkNativeCommandHandler.CDAdMediaScannerConnectionClient(filename, null);
        ...
        @VisibleForTesting
        @Deprecated
        SparkNativeCommandHandler.DownloadImageAsyncTask.DownloadImageAsyncTaskListener getListener() {
            return mListener;
        }
    }
