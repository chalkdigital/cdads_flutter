...
/**
 * A data that represents placed ads in a {@link CDAdStreamAdPlacer},
...
class PlacementData {
    ...
    @NonNull
    static PlacementData fromAdPositioning(@NonNull final CDAdClientPositioning adPositioning) {
        final List<Integer> fixed = adPositioning.getFixedPositions();
        final int interval = adPositioning.getRepeatingInterval();

        final int size = (interval == CDAdClientPositioning.NO_REPEAT ? fixed.size() : MAX_ADS);
    ...
    void placeAd(final int adjustedPosition, final NativeAd nativeAd) {
        ...
        if (desiredIndex == mDesiredCount
            ...
            CDAdLog.w("Attempted to insert an ad at an invalid position");
            return;
        }
    ...
    /**
     * @see {@link CDAdStreamAdPlacer#isAd(int)}
     */
    ...
    /**
     * @see CDAdStreamAdPlacer#getOriginalPosition(int)
     */
    ...
    /**
     * @see CDAdStreamAdPlacer#getAdjustedPosition(int)
     */
    ...
    /**
     * @see CDAdStreamAdPlacer#getOriginalCount(int)
     */
    ...
    /**
     * @see CDAdStreamAdPlacer#getAdjustedCount(int)
     */
    ...
    /**
     * @see CDAdStreamAdPlacer#insertItem(int)
     */
    ...
    /**
     * @see CDAdStreamAdPlacer#removeItem(int)
     */
    ...
    /**
     * @see CDAdStreamAdPlacer#moveItem(int, int)
     */
