...
public class CDAdVideoNativeAdRenderer implements CDAdAdRenderer<VideoNativeAd> {
     ...
     */
    public CDAdVideoNativeAdRenderer(@NonNull final MediaViewBinder mediaViewBinder) {
    ...
    @Override
    public void renderAdView(@NonNull final ViewGroup view, @NonNull final VideoNativeAd ad) {
        ad.render(view);
    }
