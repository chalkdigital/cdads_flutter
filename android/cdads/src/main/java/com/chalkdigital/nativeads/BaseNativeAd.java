 ...
 * native ad format, be sure to also implement and register an appropriate {@link CDAdAdRenderer}
...
public abstract class BaseNativeAd {
     ...
     * CDAd impression trackers to fire correctly.
     */
     ...
     * CDAd click trackers to fire correctly.
     */
    ...
    final protected void addImpressionTrackers(final Object impressionTrackers) throws ClassCastException {
        ...
        for (int i = 0; i < trackers.length(); i++) {
            try {
                ...
                CDAdLog.d("Unable to parse impression trackers.");
            }
        }
    }
        ...
        for (int i = 0; i < trackers.length(); i++) {
            try {
                addClickTracker(trackers.getString(i));
                        ...
                        Utils.logStackTrace(e);
                // This will only occur if we access a non-existent index in JSONArray.
                CDAdLog.d("Unable to parse click trackers.");
            }
        }
    }
