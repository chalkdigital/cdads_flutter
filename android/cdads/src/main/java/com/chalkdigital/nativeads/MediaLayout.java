...
import com.chalkdigital.ads.VastVideoProgressBarWidget;
import com.chalkdigital.ads.resource.DrawableConstants.GradientStrip;
...
public class MediaLayout extends RelativeLayout {
    ...
    public static final float ASPECT_MULTIPLIER_WIDTH_TO_HEIGHT = 9f / 16;
    ...
    @Nullable private ImageView mPauseButton;
    ...
    public void initForVideo() {
        ...
        final LayoutParams pauseButtonParams = new LayoutParams(mMuteSizePx, mMuteSizePx);
        pauseButtonParams.addRule(RelativeLayout.ABOVE, mVideoProgress.getId());
        pauseButtonParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
        pauseButtonParams.setMargins(mMuteSizePx, 0, 0, 0);
        ...
        mPauseButton.setImageDrawable(Drawables.NATIVE_PAUSE.createDrawable(getContext()));
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        if (Math.abs(finalHeight - curHeight) >= 2
            ...
            CDAdLog.v(String.format("Resetting mediaLayout size to w: %d h: %d", finalWidth, finalHeight));
...
//            mOverlay.setOnClickListener(playButtonListener);
    ...
    public void setPauseButtonClickListener(@Nullable OnClickListener pauseButtonListener) {
        if (mPauseButton != null && mOverlay != null) {
//            mOverlay.setOnClickListener(pauseButtonListener);
    ...
    private void updateViewState() {
        switch (mMode) {
            case IMAGE:
                ...
                setPauseButtonVisibility(INVISIBLE);
                break;
            case LOADING:
                setMainImageVisibility(VISIBLE);
