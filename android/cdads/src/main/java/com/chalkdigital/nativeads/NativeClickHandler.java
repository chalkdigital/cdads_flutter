...
public class NativeClickHandler {
    ...
    public NativeClickHandler(@NonNull final Context context, String clickAction) {
        this(context, null, clickAction);
    }

    public NativeClickHandler(@NonNull final Context context, @Nullable final String dspCreativeId, String clickAction) {
     ...
     * {@link ClickInterface#handleClick(View, String )} when a view in the view hierarchy is clicked.
     *
    ...
    public void setOnClickListener(@NonNull final View view,
        ...
        setOnClickListener(view, new OnClickListener() {
            ...
            public void onClick(View v) {
                clickInterface.handleClick(v, mClickAction);
            }
        });
    }
    ...
    public void openClickDestinationUrl(@NonNull final String clickDestinationUrl,
            @Nullable final View view, String clickAction) {
        openClickDestinationUrl(clickDestinationUrl, view, new SpinningProgressView(mContext), clickAction);
    }

    @VisibleForTesting
    void openClickDestinationUrl(@NonNull final String clickDestinationUrl,
            @Nullable final View view,
            @NonNull final SpinningProgressView spinningProgressView, String clickAction) {
        ...
        builder.withSupportedUrlActions(
                ...
                .build().handleUrl(mContext, clickDestinationUrl, clickAction);
    }
}
