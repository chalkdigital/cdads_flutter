...
public abstract class StaticNativeAd extends BaseNativeAd implements ImpressionInterface, ClickInterface {
     ...
     * cdertised app. Note that this method may return null if the star rating was either never set
     * or invalid.
     */
    @Nullable
     ...
     * with CDAd's direct-sold native ads or from mediated networks that pass back additional
     * fields.
     */
    @NonNull
    ...
    final public void setStarRating(@Nullable final Double starRating) {
        if (starRating == null) {
            ...
            CDAdLog.d("Ignoring attempt to set invalid star rating (" + starRating + "). Must be "
    ...
    final public void setImpressionMinTimeViewed(final int impressionMinTimeViewed) {
        if (impressionMinTimeViewed > 0) {
            ...
            CDAdLog.d("Ignoring non-positive impressionMinTimeViewed: " + impressionMinTimeViewed);
        }
    }
    ...
    final public void setImpressionMinPercentageViewed(final int impressionMinPercentageViewed) {
        if (impressionMinPercentageViewed >= 0 && impressionMinPercentageViewed <= 100) {
            ...
            CDAdLog.d("Ignoring impressionMinTimeViewed that's not a percent [0, 100]: " +
    ...
    final public void setImpressionMinVisiblePx(@Nullable final Integer impressionMinVisiblePx) {
        if (impressionMinVisiblePx != null && impressionMinVisiblePx > 0) {
            ...
            CDAdLog.d("Ignoring null or non-positive impressionMinVisiblePx: " +
     ...
     */
    @Override
    public void handleClick(@NonNull final View view, final String clickAction) { }
}
