...
import static com.chalkdigital.nativeads.VisibilityTracker.VisibilityTrackerListener;

/**
 * {@code CDAdAdAdapter} facilitates placing ads into an Android {@link android.widget.ListView} or
 ...
 *
 * This adapter uses a {@link CDAdStreamAdPlacer} object internally. If you
 * wish to avoid wrapping your original adapter, you can use {@code CDAdStreamAdPlacer} directly.
 */
public class CDAdAdAdapter extends BaseAdapter {
    ...
    /**
     * Creates a new CDAdAdAdapter object.
     *
     * By default, the adapter will contact the server to determine ad positions. If you
     * wish to hard-code positions in your app, see {@link CDAdAdAdapter (Context,
     * CDAdClientPositioning)}.
     *
     * @param activity The activity.
     * @param originalAdapter Your original adapter.
     */
    public CDAdAdAdapter(@NonNull final Activity activity, @NonNull final Adapter originalAdapter) {
        this(activity, originalAdapter, CDAdNativeAdPositioning.serverPositioning());
    }

    /**
     * Creates a new CDAdAdAdapter object, using server positioning.
     *
     * @param activity The activity.
     * @param originalAdapter Your original adapter.
     ...
     */
    public CDAdAdAdapter(@NonNull final Activity activity,
    ...
    /**
     * Creates a new CDAdAdAdapter object, using client positioning.
     *
     * @param activity The activity.
     * @param originalAdapter Your original adapter.
     * @param adPositioning A positioning object for specifying where ads will be placed in your
    ...
    @VisibleForTesting
    CDAdAdAdapter(@NonNull final CDAdStreamAdPlacer streamAdPlacer,
                   @NonNull final Adapter originalAdapter,
    ...
    /**
     * Registers a {@link CDAdStaticNativeAdRenderer}, supporting a specific native ad format,
     ...
     */
    public final void registerAdRenderer(@NonNull final CDAdAdRenderer adRenderer) {
     ...
     */
    public final void setAdLoadedListener(@Nullable final CDAdNativeAdLoadedListener listener) {
     ...
     * CDAdNativeAdLoadedListener} you will see a call to {@code onAdRemoved} for each of the old
     ...
     * refresh ads, call {@link #refreshAds(ListView, String, CDAdRequest)} instead of this
     * method.
     *
    ...
    public int getItemViewType(final int position) {
        ...
        if (viewType != CDAdStreamAdPlacer.CONTENT_VIEW_TYPE) {
     ...
     *
     * @see {@link CDAdStreamAdPlacer#insertItem(int)}
     ...
     *
     * @see {@link CDAdStreamAdPlacer#removeItem(int)}
     * @param originalPosition The original content position at which to add an item. If you have an
     * adjusted position, you will need to call {@link #getOriginalPosition} to get this value.
     */
    ...
    public void setOnClickListener(@NonNull final ListView listView,
        ...
        if (!NoThrow.checkNotNull(listView, "You called CDAdAdAdapter.setOnClickListener with a" +
                " null ListView")) {
            return;
        }
        if (listener == null) {
    ...
    public void setOnItemLongClickListener(@NonNull final ListView listView,
        ...
        if (!NoThrow.checkNotNull(listView, "You called CDAdAdAdapter." +
    ...
    public void setOnItemSelectedListener(@NonNull final ListView listView,
        ...
        if (!NoThrow.checkNotNull(listView, "You called CDAdAdAdapter.setOnItemSelectedListener" +
    ...
    public void setSelection(@NonNull final ListView listView, final int originalPosition) {
        if (!NoThrow.checkNotNull(listView, "You called CDAdAdAdapter.setSelection with a null " +
                "ListView")) {
            return;
        }
    ...
    public void smoothScrollToPosition(@NonNull final ListView listView,
        ...
        if (!NoThrow.checkNotNull(listView, "You called CDAdAdAdapter.smoothScrollToPosition " +
                "with a null ListView")) {
            return;
        }
     ...
     *
     * @param adUnitId The ad unit ID to use when loading ads.
     * @param cdAdRequest information to pass to the ad server.
     */
    public void refreshAds(@NonNull final ListView listView,
            @NonNull String adUnitId, @Nullable CDAdRequest cdAdRequest) {
        if (!NoThrow.checkNotNull(listView, "You called CDAdAdAdapter.refreshAds with a null " +
                "ListView")) {
            return;
        }
