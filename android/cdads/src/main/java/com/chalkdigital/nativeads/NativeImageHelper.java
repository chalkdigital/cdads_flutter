...
import com.chalkdigital.nativeads.CustomEventNative.CustomEventNativeListener;
...
//                CDAdLog.d("Failed to download a native ads image:", volleyError);
...
//                if (!isImmediate) {
//                    CDAdLog.d("Image was not loaded immediately into your ad view. You should call preCacheImages as part of your custom event loading process.");
//                }
