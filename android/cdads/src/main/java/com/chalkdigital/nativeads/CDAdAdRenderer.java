 ...
 *
 * Normally you will use the subclass {@link CDAdStaticNativeAdRenderer} with {@link
 * com.chalkdigital.nativeads.ViewBinder} to customize your ad view with your own layout. However, if you
 * wish to programmatically create or manage your ad view, you can implement {@code CDAdAdRenderer}
 * directly.
 *
 * @param <T> The ad payload type.
 */
public interface CDAdAdRenderer<T extends BaseNativeAd> {
    /**
     * Creates a new view to be used as an ad.
     * <p/>
     * This method is called when you call {@link CDAdStreamAdPlacer#getAdView}
    ...
    void renderAdView(@NonNull ViewGroup view, @NonNull T ad);
