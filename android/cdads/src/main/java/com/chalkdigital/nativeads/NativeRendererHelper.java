...
public class NativeRendererHelper {
    public static void addTextView(@Nullable final TextView textView,
        ...
        if (textView == null) {
            CDAdLog.d("Attempted to add text (" + contents + ") to null TextView.");
            return;
        }
        ...
        if (contents == null) {
            CDAdLog.d("Attempted to set TextView contents to null.");
        } else {
     ...
     * @param privacyInformationImageUrl        The image url. If this is null, the default CDAd
     *                                          icon is used.
        ...
        privacyInformationIconImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                new UrlHandler.Builder()
                        ...
                        .build().handleUrl(context, privacyInformationClickthroughUrl, null);
            }
        });
    ...
    public static void updateExtras(@Nullable final View mainView,
        ...
        if (mainView == null) {
            CDAdLog.w("Attempted to bind extras on a null main view.");
            return;
        }
        ...
        for (final String key : extrasIds.keySet()) {
            ...
            if (view instanceof ImageView) {
                ...
                CDAdLog.d("View bound to " + key + " should be an instance of TextView or ImageView.");
            }
        }
    }
}
