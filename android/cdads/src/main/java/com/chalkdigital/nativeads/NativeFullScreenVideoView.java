...
import com.chalkdigital.ads.resource.CtaButtonDrawable;
...
public class NativeFullScreenVideoView extends RelativeLayout {
    ...
    NativeFullScreenVideoView(@NonNull final Context context, int orientation,
        ...
        LayoutParams spinnerParams =
                new LayoutParams(mPlayControlSizePx, mPlayControlSizePx);
        ...
        LayoutParams bottomGradientParams = new LayoutParams(
                LayoutParams.MATCH_PARENT, mGradientStripHeightPx);
        ...
        LayoutParams topGradientParams = new LayoutParams(
                LayoutParams.MATCH_PARENT, mGradientStripHeightPx);
    ...
    private void updateControlLayouts() {
        final LayoutParams ctaParams =
                new LayoutParams(mCtaWidthPx, mCtaHeightPx);
        ctaParams.setMargins(mCtaMarginPx, mCtaMarginPx, mCtaMarginPx, mCtaMarginPx);
        final LayoutParams privacyInformationIconParams =
                new LayoutParams(mPrivacyInformationIconSizePx,
                        mPrivacyInformationIconSizePx);
        final LayoutParams closeParams =
                new LayoutParams(mCloseControlSizePx, mCloseControlSizePx);
