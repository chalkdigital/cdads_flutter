...
public class ProgressBarDrawable extends BaseWidgetDrawable {
    ...
    public void setDurationAndSkipOffset(final Integer duration, final int skipOffset) {
        mDuration = duration;
    ...
    public void setProgress(final int currentProgress) {
        ...
        if (currentProgress >= mLastProgress) {
            ...
            CDAdLog.d(String.format("Progress not monotonically increasing: last = %d, current = %d",
                    mLastProgress,
                    currentProgress));
            forceCompletion();
        }
