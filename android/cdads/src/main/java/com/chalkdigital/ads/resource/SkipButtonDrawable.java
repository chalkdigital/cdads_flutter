...
public class SkipButtonDrawable extends BaseWidgetDrawable {
    ...
    public SkipButtonDrawable(@NonNull final Context context) {
        super();
        ...
        mTextRect = new Rect();
        try {
            mCtaText = context.getResources().getText(context.getResources().getIdentifier("Skip", "string", context.getPackageName())).toString();
