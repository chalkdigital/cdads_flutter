...
import static com.chalkdigital.common.Constants.FIFTEEN_MINUTES_MILLIS;
...
public class WebViewCacheService {
    ...
    public static void storeWebViewConfig(@NonNull final Long broadcastIdentifier,
        ...
        if (sWebViewConfigs.size() >= MAX_SIZE) {
            CDAdLog.w(
                    "Unable to cache web view. Please destroy some via CDAdInterstitial#destroy() and try again.");
            return;
        }
