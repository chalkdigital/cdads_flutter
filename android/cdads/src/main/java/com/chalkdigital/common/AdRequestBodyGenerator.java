...
import static com.chalkdigital.common.ClientMetadata.CDAdNetworkType;

public abstract class AdRequestBodyGenerator extends BaseUrlGenerator {
    ...
    /**
     * nv = native version. This is the version of CDAd.
     */
    ...
    /**
     * Whether or not the location came from the CDAd SDK
     * and not the developer. 1 = from CDAd.
     */
    ...
    public AdRequestBodyGenerator(Context context) {
        mContext = context;
    }

    public AdRequestBodyGenerator withAdUnitId(String adUnitId) {
        mAdUnitId = adUnitId;
        return this;
    }

    public AdRequestBodyGenerator withKeywords(String keywords) {
        mKeywords = keywords;
        return this;
    }

    public AdRequestBodyGenerator withLocation(Location location) {
        mLocation = location;
        return this;
    }
    ...
    protected void setNetworkType(CDAdNetworkType networkType) {
    ...
    private void addParam(String key, CDAdNetworkType value) {
