...
public abstract class BaseEvent {
    ...
    @Nullable private final CDAdNetworkType mNetworkType;
    ...
    public String getObfuscatedClientAdvertisingId() {
        // This is a placeholder for the cdertising id until we approve a plan to use the
        // real value
        return "ifa:XXXX";
    }
    ...
    @Nullable
    public CDAdNetworkType getNetworkType() {
        return mNetworkType;
    }
