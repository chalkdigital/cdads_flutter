...
public class Constants {
    ...
    public static final String HOST = "ads.chalkdigital.com";
    ...
    public static final String DISPLAY_MANAGER_NAME = "Chalk Digital";
    public static final String CDLocTypeGPS                                  =  "0";
    public static final String CDLocTypeOther                                =  "3";
    public static final String CDLocTypeIP                                   =  "2";
}
