...
class AvidViewabilitySession implements ExternalViewabilitySession {
    private static final String AVID_MANAGER_PATH =
            "com.integralads.avid.library.chalkdigital.AvidManager";
    private static final String EXTERNAL_AVID_AD_SESSION_CONTEXT_PATH =
            "com.integralads.avid.library.chalkdigital.session.ExternalAvidAdSessionContext";
    private static final String AVID_AD_SESSION_MANAGER_PATH =
            "com.integralads.avid.library.chalkdigital.session.AvidAdSessionManager";
        ...
        if (sAvidAdSessionContextDeferred == null) {
            try {
                ...
                sAvidAdSessionContextDeferred = Reflection.instantiateClassWithConstructor(
                        ...
                        new Object[] {CDAdConstants.CDAdSdkVersion, true});
            } catch (Exception e) {
                        Utils.logStackTrace(e);
                CDAdLog.d("Unable to generate Avid deferred ad session context: "
                        + e.getMessage());
            }
        }
        ...
        if (sAvidAdSessionContextNonDeferred == null) {
            try {
                ...
                sAvidAdSessionContextNonDeferred = Reflection.instantiateClassWithConstructor(
                        ...
                        new Object[] {CDAdConstants.CDAdSdkVersion});
            } catch (Exception e) {
                        Utils.logStackTrace(e);
                CDAdLog.d("Unable to generate Avid ad session context: "
                        + e.getMessage());
            }
        }
    ...
    public Boolean createDisplaySession(@NonNull final Context context,
        ...
        try {
            ...
            return true;
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to execute Avid start display session: " + e.getMessage());
            return false;
        }
    }
    ...
    public Boolean startDeferredDisplaySession(@NonNull final Activity activity) {
        ...
        if (mAvidDisplayAdSession == null) {
            CDAdLog.d("Avid DisplayAdSession unexpectedly null.");
            return false;
        }
        ...
        try {
            ...
            if (deferredAdSessionListener == null) {
                CDAdLog.d("Avid AdSessionListener unexpectedly null.");
                return false;
            }
            ...
            return true;
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to execute Avid record deferred session: "
                    + e.getMessage());
            return false;
        }
    }
    ...
    public Boolean endDisplaySession() {
        ...
        try {
            ...
            return true;
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to execute Avid end session: " + e.getMessage());
            return false;
        }
    }
    ...
    public Boolean createVideoSession(@NonNull final Activity activity, @NonNull final View view,
        ...
        try {
            ...
            return true;
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to execute Avid start video session: " + e.getMessage());
            return false;
        }
    }
    ...
    public Boolean registerVideoObstructions(@NonNull final List<View> views) {
        ...
        if (mAvidVideoAdSession == null) {
            CDAdLog.d("Avid VideoAdSession unexpectedly null.");
            return false;
        }
        ...
        try {
            ...
            return true;
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to register Avid video obstructions: " + e.getMessage());
            return false;
        }
    }
    ...
    public Boolean recordVideoEvent(@NonNull final VideoEvent event, final Integer duration, final Integer playHeadMillis, final Integer volume) {
        ...
        try {
            switch (event) {
                ...
                default:
                    CDAdLog.d("Unexpected video event type: " + event);
                    return false;
            }
        } catch (Exception e) {
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to execute Avid video event for "
    ...
    public Boolean endVideoSession() {
        ...
        try {
            ...
            return true;
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to execute Avid end video session: " + e.getMessage());
            return false;
        }
    }
