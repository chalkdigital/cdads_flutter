...
class MoatViewabilitySession implements ExternalViewabilitySession {
    ...
    // CDAd's partner identifier with Moat. Partner code is normally parsed from the video
    ...
    public Boolean initialize(@NonNull final Context context) {
        ...
        if (context instanceof Activity) {
            ...
            try {
                ...
                CDAdLog.d("Unable to initialize Moat, error obtaining application context.");
                return false;
            }
        }
        ...
        try {
            ...
            return true;
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to initialize Moat: " + e.getMessage());
            return false;
        }
    }
...
//                new Reflection.MethodBuilder(mMoatWebAdTracker, "startTracking").execute();
            ...
            return true;
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to execute Moat start display session: "
                    + e.getMessage());
            return false;
        }
    }
    ...
    public Boolean startDeferredDisplaySession(@NonNull final Activity activity) {
        ...
        if (mMoatWebAdTracker == null) {
            CDAdLog.d("MoatWebAdTracker unexpectedly null.");
            return false;
        }
...
//            new Reflection.MethodBuilder(mMoatWebAdTracker, "startTracking").execute();
            ...
            return true;
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to record deferred display session for Moat: " + e.getMessage());
            return false;
        }
    }
    ...
    public Boolean endDisplaySession() {
        ...
        if (mMoatWebAdTracker == null) {
            CDAdLog.d("Moat WebAdTracker unexpectedly null.");
            return false;
        }
        ...
        try {
            ...
            return true;
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to execute Moat end session: " + e.getMessage());
        }
    ...
    public Boolean createVideoSession(@NonNull final Activity activity, @NonNull final View view,
        ...
        if (TextUtils.isEmpty(partnerCode)) {
            CDAdLog.d("partnerCode was empty when starting Moat video session");
            return false;
        }
        ...
        try {
            ...
            return true;
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to execute Moat start video session: " + e.getMessage());
            return false;
        }
    }
    ...
    public Boolean onVideoPrepared(@NonNull final View playerView, final Integer duration, final Integer volume) {
        ...
        if (mMoatVideoTracker == null) {
            CDAdLog.d("Moat VideoAdTracker unexpectedly null.");
            return false;
        }
        ...
        try {
            ...
            return true;
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to execute Moat onVideoPrepared: " + e.getMessage());
            return false;
        }
    }
    ...
    public Boolean recordVideoEvent(@NonNull final VideoEvent event, final Integer duration, final Integer playHeadMillis, final Integer volume) {
        ...
        try {
            switch (event) {
                ...
                default:
                    CDAdLog.d("Unexpected video event: " + event.getMoatEnumName());
                    return false;
            }
        } catch (Exception e) {
                        Utils.logStackTrace(e);
            CDAdLog.d("Video event " + event.getMoatEnumName() + " failed. "
                    + e.getMessage());
            return false;
        }
    }
    ...
    public Boolean endVideoSession() {
        ...
        try {
            ...
            return true;
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to execute Moat end video session: " + e.getMessage());
            return false;
        }
    }
     ...
     * Example: https://z.moatads.com.chalkdigitalppdisplay698212075271/moatad.js#moatClientLevel1=appname&moatClientLevel2=adunit&moatClientLevel3=creativetype&moatClientSlicer1=adformat
     *
