...
import static com.chalkdigital.common.DiskLruCache.open;
...
public class CacheService {
    ...
    static final String UNIQUE_CACHE_NAME = "cdads-cache";
    ...
    public static boolean initializeDiskCache(final Context context) {
        ...
        if (sDiskLruCache == null) {
            ...
            try {
                ...
                CDAdLog.d("Unable to create DiskLruCache", e);
                return false;
            }
        }
        return true;
            ...
            if (in != null) {
                ...
                try {
                    ...
                    Streams.closeStream(buffIn);
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to get from DiskLruCache", e);
        } finally {
            if (snapshot != null) {
                snapshot.close();
            }
    ...
    public static boolean putToDiskCache(final String key, final InputStream content) {
        ...
        try {
            ...
            editor.commit();
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.d("Unable to put to DiskLruCache", e);
            try {
                if (editor != null) {
                    editor.abort();
                }
