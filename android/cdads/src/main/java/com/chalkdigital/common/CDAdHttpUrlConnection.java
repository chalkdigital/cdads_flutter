...
public abstract class CDAdHttpUrlConnection extends HttpURLConnection {
    private static final int CONNECT_TIMEOUT = 10000;
    private static final int READ_TIMEOUT = 10000;

    private CDAdHttpUrlConnection(URL url) {
        super(url);
    }
    ...
    static boolean isUrlImproperlyEncoded(@NonNull String url) {
        try {
            URLDecoder.decode(url, "UTF-8");
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.w("Url is improperly encoded: " + url);
            return true;
        }
        return false;
    }
        ...
        try {
            ...
            uri = new URI(url.getProtocol(), url.getUserInfo(), url.getHost(), url.getPort(),
                    url.getPath(), url.getQuery(), url.getRef());
                        ...
                        Utils.logStackTrace(e);
            CDAdLog.w("Failed to encode url: " + urlString);
            throw e;
        }
        return uri;
    }
