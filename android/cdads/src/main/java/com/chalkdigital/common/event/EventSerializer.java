...
public class EventSerializer {
    ...
    public JSONArray serializeAsJson(@NonNull List<BaseEvent> events) {
        ...
        for (BaseEvent event : events) {
            try {
                ...
                CDAdLog.d("Failed to serialize event \"" + event.getName() + "\" to JSON: ", e);
            }
        }
        return jsonArray;
    }
    ...
    public JSONObject serializeAsJson(@NonNull BaseEvent event) throws JSONException {
        ...
        jsonObject.put("client_cdertising_id", event.getObfuscatedClientAdvertisingId());
        ...
        // Network Details
        ClientMetadata.CDAdNetworkType cdAdNetworkType = event.getNetworkType();
        jsonObject.put("network_type", cdAdNetworkType == null ? null : cdAdNetworkType.getId());
